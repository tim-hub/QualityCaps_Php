        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="role" id="role-field" value="{{ old('role', $user->role ) }}" />
                </div> 
                <div class="form-group">
                    <label for="email_confirmed-field">Email_confirmed</label>
                    <input class="form-control" type="text" name="email_confirmed" id="email_confirmed-field" value="{{ old('email_confirmed', $user->email_confirmed ) }}" />
                </div> 
                <div class="form-group">
                    <label for="enabled-field">Enabled</label>
                    <input class="form-control" type="text" name="enabled" id="enabled-field" value="{{ old('enabled', $user->enabled ) }}" />
                </div>
